...
/**
 * This class contains local employee information. This class should only be
 * initialized and changed by the input data.
 * 
 * @author anirbanpoddar
 * 
 */
public class LocalEmployeeImpl extends EmployeeImpl {

	/**
	 * Constructor to set local employee data.
	 * 
	 * @param String
	 ...
	 */
	public LocalEmployeeImpl(String name, String telephone, String email, String address, String type) {
	...
	public String getInformation() {
		...
		return getName() + DomainConstants.DOMFILESEP + getTelephone();
